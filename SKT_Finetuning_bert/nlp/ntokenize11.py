...
from model.ndata1 import Corpus
from model.utils11 import PreProcessor, PadSequence
...
if __name__ == '__main__':
    ...
    # training
    t2iL = Corpus("data/my_train.txt", preprocessor.preprocess)
    pd.DataFrame.from_records([{'idx':t2iL}]).to_csv('t2iL.csv', sep='\t', index=False, header=False)
